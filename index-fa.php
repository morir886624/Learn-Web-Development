...
<head>
  ...
  <title>یادگیری توسعه وب | صفحه اصلی</title>
  <meta name="description" content="یک پلتفرم ساده برای یادگیری گام‌به‌گام توسعه وب، ساخته شده توسط یک دانشجوی علاقه‌مند به برنامه‌نویسی.">
...
<main>
  ...
  <section class="information">
    ...
    <p class="p">برای طراحی سایت (با کدنویسی-روش حرفه ای) باید به ترتیب 4 زبان زیر را یاد بگیرید:</p>
