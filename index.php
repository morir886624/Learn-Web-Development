  ...
  <!-- image principal -->
    ...
    <section class="information">
      ...
      <div class="information-box box">
        ...
        <div class="divs-information box">
          <h3>2- Identify the Specializations:</h3>
          <p>Web Development requires three main specializations. You can choose one based on your interests:
        ...
        <div class="divs-information box">
          ...
          <p class="p">For professional web design (coding-based), you need to learn the following languages in order:</p>
        ...
        <div class="divs-information box">
          <h3>3-JavaScript:</h3>
          <p>JavaScript makes web pages dynamic. If you want to add animations or interactive menus, JavaScript is essential.</p>
        </div>
